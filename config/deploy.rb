...
set :keep_releases, 5
default_run_options[:pty] = true
role :web, "https://192.168.0.106"                          # Your HTTP server, Apache/etc
role :app, "https://192.168.0.106"                          # This may be the same as your `Web` server
role :db,  "https://192.168.0.106", :primary => true        # This is where Rails migrations will run

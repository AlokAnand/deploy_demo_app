...
set :application, "https://127.0.0.1"
...
set :user, "alok"
set :use_sudo, false
role :web, "https://127.0.0.1"                          # Your HTTP server, Apache/etc
role :app, "https://127.0.0.1"                          # This may be the same as your `Web` server
role :db,  "https://127.0.0.1", :primary => true        # This is where Rails migrations will run
role :db,  "https://127.0.0.1"
